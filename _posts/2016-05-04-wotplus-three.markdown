...
![启动图]http://zhangxx0.gitee.io/blog_image/wotplus/wotplus_001.jpg)
...
使用侧滑菜单罗列功能模块；  
![ 侧滑菜单图 ]http://zhangxx0.gitee.io/blog_image/wotplus/wotplus_bolg_01_01.png)
...
![两个Card]http://zhangxx0.gitee.io/blog_image/wotplus/wotplus_blog_01_02.jpg)  
...
从html中找到动态获取军团信息的js：  
![军团信息获取](http://zhangxx0.gitee.io/blog_image/wotplus/claninfo.jpg)  
...
![ 解析完的成就类 ](http://zhangxx0.gitee.io/blog_image/wotplus/Achievements.png)
